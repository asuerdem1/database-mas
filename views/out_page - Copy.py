...
# datas =[
#     {'variable': 'v1', 'nick_name': 'aa', 'min': '0', 'max': '1000'},
#     {'variable': 'v2', 'nick_name': 'bb', 'min': '', 'max': ''},
#     {'variable': 'v3', 'nick_name': 'cc', 'min': '0', 'max': '1000'},
#     {'variable': 'v4', 'nick_name': 'dd', 'min': '', 'max': ''},
#     {'variable': 'v7', 'nick_name': 'country', 'min': '', 'max': ''}
#     ]
# table_name = 'eu_2005'
# year = '2005'
# df = getTableDf(datas, year, table_name)
# print(df)
def getLayout():
...
def update_y_timeseries(hoverData, xaxis_column_name, axis_type):
    ...
    dff = dfin[dfin['Country Name'] == country_name]
...
def update_x_timeseries(hoverData, yaxis_column_name, axis_type):
    dff = dfin[dfin['Country Name'] == hoverData['points'][0]['customdata']]
